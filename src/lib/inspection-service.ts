...
export class InspectionService {
   ...
   */
  static async createInspectionForm(
    ...
    try {
      ...
      const formData = {
        ...
        status: "pending",
        form_link: formLink,
        diagram_data: data.diagramPoints
          ? { points: data.diagramPoints }
          : null,
      };
   ...
   */
  static async getInspectionFormByLink(
    formLink: string,
   ...
   */
  static async updateInspectionForm(
    formLink: string,
    ...
    try {
      ...
      if (data.signatureData !== undefined)
        updateData.signature_data = data.signatureData;
      if (data.diagramPoints !== undefined)
        updateData.diagram_data = { points: data.diagramPoints };
      ...
      if (error) {
        console.error(
          "Supabase error details in updateInspectionForm:",
