  ...
  const testCases = [
    {
      ...
      data: {
        ...
        pdf_attachment:
          "https://lngsgyvpqhjmedjrycqw.supabase.co/storage/v1/object/public/pdfs/rental_6_passenger_150_oman_2025-04-09.pdf",
      },
    },
    {
  ...
  for (const testCase of testCases) {
    ...
    try {
      ...
      if (testCase.type === "admin-notification") {
        ...
        result = await sendFormEmail(testCase.type, testCase.data);
      }
