...
const validateForm = () => {
  if (!selectedProperty.value) {
    quasar.notify({
      type: 'negative',
      message: 'Por favor seleccione una propiedad',
      position: 'top'
    })
    return false
  }
  ...
  if (!selectedCartType.value) {
    quasar.notify({
      type: 'negative',
      message: 'Por favor seleccione un tipo de carrito',
      position: 'top'
    })
    return false
  }
  ...
  if (!guestInfo.name?.trim()) {
    quasar.notify({
      type: 'negative',
      message: 'Por favor ingrese el nombre del invitado',
      position: 'top'
    })
    return false
  }
  ...
  if (diagramMarkings.value.length === 0) {
    quasar.notify({
      type: 'negative',
      message: 'Por favor realice marcas en el diagrama',
      position: 'top'
    })
    return false
  }
